...
source "proxmox-iso" "ubuntu-22-04-ansible" {
  ...
  # VM configuration
  vm_name              = "ubuntu-22.04-ansible-template-${local.timestamp}"
  template_description = "Ubuntu 22.04 LTS template with Ansible provisioning built on ${timestamp()}"
